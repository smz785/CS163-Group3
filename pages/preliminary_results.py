...
def layout():
    ...
    uplift_vals = decile_df['realized_uplift'].tolist()
    ...
    return html.Div([
        ...
        html.Section([
            ...
            callout("Advertising generates approximately 1 additional conversion per ~870 users shown an ad."),
            html.H3("Implications"),
            html.P(
                "This refutes the common assumption that advertising mainly drives purchases. Conversion "
                "improvements depend not only on exposure but also on what happens after the user arrives on the site."
            ),
            ...
            html.P("Because conversion is rare, AUC is more useful than accuracy."),
            html.Img(src="/assets/ROC Curve For Treated and Control.png",
        ...
        html.Section([
            ...
            html.P(
                ...
                "We then rank users from highest to lowest uplift and divide them into five groups (bins)."
            ),
            html.P(
                "The idea is that users in the top group should benefit the most from advertising. "
                "So ideally, we expect the top 20% group to have the highest increase in conversion due to ads."
            ),
            ...
            callout(
                ...
                "However, the pattern is not perfectly ordered — the model is not perfect, but still captures useful differences."
            ),
            insight_box("Broader Impacts", [
        ...
        html.Section([
            ...
            html.P(
                ...
                "both random targeting and a treat-all strategy."
            ),
            callout(
            ...
            html.P(
                ...
                "This demonstrates that most advertising impact is concentrated in a small subset of users."
            ),
